      ...
      <section style={{
        ...
        <div style={{ maxWidth: 620, margin: "0 auto", position: "relative", zIndex: 2 }}>
          ...
          <p style={{
            ...
            Enroll at Luv U Beauty Academy and develop the skills to create
            professional beauty looks from day one.
          </p>
          <a
            href="https://wa.me/919487992728?text=Hi! I want to learn to create professional beauty looks. Please share course details."
            target="_blank"
